...
{
    public Func<ProjectDoc, Task<Smx.Backend.Agents.AgentRunResult<ConstraintsDoc>>> Intake { get; set; } =
        p => Task.FromResult(Smx.Backend.Agents.AgentRunResult<ConstraintsDoc>.Ok(new ConstraintsDoc
        {
    ...
    public Func<ProjectDoc, ConstraintsDoc, RevisionDoc?, Task<Smx.Backend.Agents.AgentRunResult<CandidatesDoc>>> Discovery { get; set; } =
        (_, c, _) => Task.FromResult(Smx.Backend.Agents.AgentRunResult<CandidatesDoc>.Ok(new CandidatesDoc
        {
    ...
    public Func<ConstraintsDoc, CandidateSubstance, RevisionDoc?, Task<Smx.Backend.Agents.AgentRunResult<VerdictDoc>>> Regulatory { get; set; } =
        (c, cand, _) => Task.FromResult(Smx.Backend.Agents.AgentRunResult<VerdictDoc>.Ok(new VerdictDoc
        {
