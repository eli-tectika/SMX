 ...
 * FILE (§5, and D9 of the 2026-07-29 design — the gate survives, its predicate moved from "a human
 * signed this sheet" to "a validated, indexed sheet exists"), and the button is disabled with the
 * reason rather than hidden — a missing safety sheet is what blocks an order, and hiding the control
 * would hide the blocker with it.
 *
  ...
  return (
    <>
      <SectionHeader
        ...
        hint="the markers of the signed codes — each order gated on a safety sheet being on file"
      />
        ...
        <div className="banner warn" role="alert" style={{ marginBottom: 8 }}>
          ...
          <div>
            ...
            <div className="tiny" style={{ marginTop: 3 }}>
              ...
              makes a safety sheet a hard precondition for an order, so ordering is withheld until the
