        ...
        IReadOnlyCollection<VerdictDoc> verdicts, string generatedAt)
    {
        ...
        return new MatrixDoc
        {
            ...
            Cells = [.. Cells(c).Select(cell =>
            {
                ...
                // determination — erasing, on the screen that exists to show it, whether a human ruled at
                // all. Named arguments make that transposition a compile error instead.
