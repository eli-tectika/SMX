...
var sharedEnv = [
  ...
  // Deployment names stay parameters rather than the literals origin/main inlined here: ai.bicep is what
  // actually creates them, so a literal here is a second source of truth that silently rots when it moves.
